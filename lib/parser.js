...
export default class Parser {
    ...
    constructor(serializedState) {
        ...
        let parserHeader = document.createElement('div');
        parserHeader.classList.add('parserHeader');
        this.element.appendChild(parserHeader);
        ...
        this.subscriptions.add(atom.workspace.observeActiveTextEditor(editor => {
            ...
            if (cachedEditor){
                ParserMethods.buildParserHeader(parserHeader, cachedEditor.parseResults);
                ...
                ParserMethods.buildParserHeader(parserHeader);
